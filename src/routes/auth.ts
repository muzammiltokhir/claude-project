...
router.post(
  ...
  async (req: Request<{}, AuthTokenResponse | ErrorResponse>, res: Response<AuthTokenResponse | ErrorResponse>) => {
    try {
...
router.post(
  ...
  async (req: Request<{}, AuthTokenResponse | ErrorResponse>, res: Response<AuthTokenResponse | ErrorResponse>) => {
    try {
      ...
      const { email, password }: EmailPasswordLoginRequest = req.body;
...
router.post(
  ...
  async (req: Request<{}, LoginResponse | ErrorResponse>, res: Response<LoginResponse | ErrorResponse>) => {
    try {
      // Check for validation errors
      const errors = validationResult(req);
      if (!errors.isEmpty()) {
      ...
      const { idToken }: LoginRequest = req.body;
...
router.post(
  ...
  async (req: Request<{}, TokenExchangeResponse | ErrorResponse>, res: Response<TokenExchangeResponse | ErrorResponse>) => {
    try {
      // Check for validation errors
      const errors = validationResult(req);
      if (!errors.isEmpty()) {
      ...
      const { idToken }: TokenExchangeRequest = req.body;
